...
RUN curl -L https://github.com/KaiserLancelot/kpkg/releases/download/v1.0.1/pyftsubset \
    -o pyftsubset && \
...
RUN mkdir dependencies && \
    cd dependencies && \
    curl -L https://github.com/KaiserLancelot/kpkg/releases/download/v1.0.1/kpkg-1.0.1-Linux.deb \
    -o kpkg.deb && \
    dpkg -i kpkg.deb && \
