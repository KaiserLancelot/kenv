...
RUN curl -fsSL https://github.com/KaiserLancelot/klib/releases/download/v1.17.0/klib-1.17.0-Linux.deb \
    -o klib.deb && \
    dpkg -i klib.deb && \
    rm klib.deb
...
RUN mkdir dependencies && \
    cd dependencies && \
    curl -fsSL https://github.com/KaiserLancelot/kpkg/releases/download/v1.10.0/kpkg-1.10.0-Linux.deb \
    -o kpkg.deb && \
    dpkg -i kpkg.deb && \
