...
RUN curl -fsSL https://github.com/KaiserLancelot/klib/releases/download/v1.14.0/klib-1.14.0-Linux.deb \
    -o klib.deb && \
    dpkg -i klib.deb && \
    rm klib.deb
...
RUN mkdir dependencies && \
    cd dependencies && \
    curl -fsSL https://github.com/KaiserLancelot/kpkg/releases/download/v1.7.0/kpkg-1.7.0-Linux.deb \
    -o kpkg.deb && \
    dpkg -i kpkg.deb && \
