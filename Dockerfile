...
RUN curl -fsSL https://github.com/KaiserLancelot/klib/releases/download/v1.16.1/klib-1.16.1-Linux.deb \
    -o klib.deb && \
    dpkg -i klib.deb && \
    rm klib.deb
...
RUN mkdir dependencies && \
    cd dependencies && \
    curl -fsSL https://github.com/KaiserLancelot/kpkg/releases/download/v1.9.2/kpkg-1.9.2-Linux.deb \
    -o kpkg.deb && \
    dpkg -i kpkg.deb && \
