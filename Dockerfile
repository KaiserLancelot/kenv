...
RUN mkdir dependencies && \
    cd dependencies && \
    curl -L https://github.com/KaiserLancelot/kpkg/releases/download/v0.9.11/kpkg-0.9.11-Linux.deb \
    -o kpkg.deb && \
    dpkg -i kpkg.deb && \
    ...
    curl -L https://github.com/KaiserLancelot/kpkg/releases/download/v0.9.11/pyftsubset -o pyftsubset && \
